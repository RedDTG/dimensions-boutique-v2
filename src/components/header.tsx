...
export const Header: React.FC = () => {
    ...
    return <header className="navbar flex-wrap md:flex-nowrap justify-between md:justify-normal bg-base-200 sticky top-0 h-20 z-50 p-0">
        ...
        <button onClick={toggleHidden} type="button" className="md:hidden inline-flex mr-2 p-2 rounded-lg text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
